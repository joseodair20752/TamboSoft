...
Begin VB.Form frmAbout 
   ...
   Caption         =   "Acerca de Software de tambo 1.0"
   ClientHeight    =   4935
   ClientLeft      =   2340
   ClientTop       =   1935
   ClientWidth     =   5940
   ...
   Begin VB.Label Label4 
      ...
      Caption         =   "Este sofware está dedicado esclusivamente para productores y estancieros solamente para el sector rural "
      BeginProperty Font 
         Name            =   "Book Antiqua"
         Size            =   8.25
         Charset         =   0
