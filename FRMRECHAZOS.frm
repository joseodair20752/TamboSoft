...
Begin VB.Form FRMRECHAZOS 
   Caption         =   "INGRESO DE RECHAZOS"
   ClientHeight    =   9675
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   16005
   ...
   Begin VB.ComboBox ComboCOMENTARIO 
      Height          =   315
      ItemData        =   "FRMRECHAZOS.frx":0000
      Left            =   5040
      List            =   "FRMRECHAZOS.frx":0007
      TabIndex        =   11
      Top             =   6360
      Width           =   3495
   End
   ...
   Begin VB.ListBox List1 
      Height          =   2595
      ItemData        =   "FRMRECHAZOS.frx":0014
      Left            =   0
      List            =   "FRMRECHAZOS.frx":0042
      TabIndex        =   9
      Top             =   2880
      Width           =   2775
   End
   ...
   Begin VB.ComboBox ComboRESPONSABLE 
      Height          =   315
      ItemData        =   "FRMRECHAZOS.frx":00CA
      Left            =   5040
      List            =   "FRMRECHAZOS.frx":00DA
      TabIndex        =   6
      Top             =   5640
      Width           =   3495
   End
   ...
   Begin VB.ComboBox ComboCAUSA 
      Height          =   315
      ItemData        =   "FRMRECHAZOS.frx":00FD
      Left            =   5040
      List            =   "FRMRECHAZOS.frx":010A
      TabIndex        =   3
      Top             =   3600
      Width           =   3375
   End
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"FRMRECHAZOS.frx":0135
      OLEDBString     =   $"FRMRECHAZOS.frx":01BE
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "CARGA_RECHAZO"
      Caption         =   "Adodc1"
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "REGISTROS DE VACAS CON RECHAZOS"
      ColumnCount     =   2
...
RESPUESTA = MsgBox("¿CONFIRMA EL INGRESO DE LOS DATOS DEL REACHAZO?", vbQuestion + vbYesNo, "CONFIRMACION")
If RESPUESTA = vbYes Then
On Error GoTo ERRGRABAR
With DataEnvironment1.rsCARGA_RECHAZO
.Open
.AddNew
!RP = txtRP.Text
!FECHA_DEL_EVENTO = txtFECHA_DEL_EVENTO.Text
!CAUSA = ComboCAUSA.Text
