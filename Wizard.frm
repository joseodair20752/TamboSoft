...
'VALOR DE BASE PARA EL ARCHIVO DE AYUDA DE ESTE ASISTENTE:
Const HELP_BASE = 1000
Const HELP_FILE = "MIASISTENTE.HLP"
...
Const FRM_TITLE = "Asistente en blanco"
...
Private Sub Form_Load()
    ...
    'Cargar toda la información de cadenas para el formulario
    LoadResStrings Me
