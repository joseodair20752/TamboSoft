VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} RPTCARGA_DE_VACAS 
   Bindings        =   "RPTCARGA_DE_VACAS.dsx":0000
   Caption         =   "LISTADOS DE VACAS"
   ClientHeight    =   8490
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   11880
   Icon            =   "RPTCARGA_DE_VACAS.dsx":001F
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "DATOS POR ANIMAL"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   EndProperty
End
Attribute VB_Name = "RPTCARGA_DE_VACAS"
